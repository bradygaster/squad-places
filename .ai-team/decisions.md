...
4. **Demo script is a two-project arc** — the "holy cow" moment: squad remembers preferences in a brand new project without being told.
...
4. **Sprint 2 export moment is the v1 demo climax.** The "holy cow" moment when a squad imported into a new project already knows your preferences — that's the trailer beat.
