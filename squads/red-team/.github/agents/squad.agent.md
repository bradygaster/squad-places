...
- **Version:** 0.10.0-build.2 (see HTML comment above — this value is stamped during install/upgrade). Include it as `Squad v0.10.0-build.2` in your first response of each session (e.g., in the acknowledgment or greeting).
