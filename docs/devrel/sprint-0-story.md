...
- **The export moment.** Squad learns preferences in Project A, gets exported, gets imported into Project B, and already knows your style. This is the "holy cow" demo from Proposal 014. If this works, it's the v1 launch trailer.
